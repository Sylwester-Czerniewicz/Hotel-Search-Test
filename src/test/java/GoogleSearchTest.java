...
public class GoogleSearchTest extends BaseSeleniumTest {
    ...
    public void googleSearcnTest()  {
        ...
        PageFactory.initElements(driver, GoogleSearchTest.class);
        driver.get("https://google.com");
        searchInput.get(0).sendKeys("top design studio");
        helper.takeScreenshot();
        searchInput.get(0).sendKeys(Keys.ENTER);
        driver.findElement(By.partialLinkText("Top Design Studio")).click();
        helper.takeScreenshot();
        Assert.assertEquals(driver.getTitle(), "Wnętrza i meble w klasie VIP. Projektowanie, stylizacja i produkcja.");
